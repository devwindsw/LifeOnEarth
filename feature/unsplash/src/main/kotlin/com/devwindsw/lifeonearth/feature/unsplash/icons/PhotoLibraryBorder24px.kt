...
public val UnsplashIcons.PhotoLibraryBorder24px: ImageVector
    get() {
        if (_photoLibraryBorder24px != null) {
            return _photoLibraryBorder24px!!
        }
        _photoLibraryBorder24px = Builder(name = "PhotoLibrary24px", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                quadTo(320.0f, 160.0f, 320.0f, 160.0f)
                quadTo(320.0f, 160.0f, 320.0f, 160.0f)
                lineTo(320.0f, 640.0f)
                quadTo(320.0f, 640.0f, 320.0f, 640.0f)
                quadTo(320.0f, 640.0f, 320.0f, 640.0f)
                close()
...
private var _photoLibraryBorder24px: ImageVector? = null
