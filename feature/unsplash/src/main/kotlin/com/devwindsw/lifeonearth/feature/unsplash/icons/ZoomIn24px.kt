...
public val UnsplashIcons.ZoomIn24px: ImageVector
    get() {
        if (_zoomIn24px != null) {
            return _zoomIn24px!!
        }
        _zoomIn24px = Builder(name = "ZoomIn24px", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(340.0f, 500.0f)
                lineTo(340.0f, 420.0f)
                lineTo(260.0f, 420.0f)
                lineTo(260.0f, 340.0f)
                lineTo(340.0f, 340.0f)
                lineTo(340.0f, 260.0f)
                lineTo(420.0f, 260.0f)
                lineTo(420.0f, 340.0f)
                lineTo(500.0f, 340.0f)
                lineTo(500.0f, 420.0f)
                lineTo(420.0f, 420.0f)
                lineTo(420.0f, 500.0f)
                lineTo(340.0f, 500.0f)
                close()
            }
        }
        .build()
...
private var _zoomIn24px: ImageVector? = null
