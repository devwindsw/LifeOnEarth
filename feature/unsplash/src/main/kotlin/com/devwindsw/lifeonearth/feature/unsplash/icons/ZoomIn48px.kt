...
public val UnsplashIcons.ZoomIn48px: ImageVector
    get() {
        if (_zoomIn48px != null) {
            return _zoomIn48px!!
        }
        _zoomIn48px = Builder(name = "ZoomIn48px", defaultWidth = 48.0.dp, defaultHeight = 48.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(346.0f, 486.0f)
                lineTo(346.0f, 404.0f)
                lineTo(264.0f, 404.0f)
                lineTo(264.0f, 344.0f)
                lineTo(346.0f, 344.0f)
                lineTo(346.0f, 263.0f)
                lineTo(406.0f, 263.0f)
                lineTo(406.0f, 344.0f)
                lineTo(487.0f, 344.0f)
                lineTo(487.0f, 404.0f)
                lineTo(406.0f, 404.0f)
                lineTo(406.0f, 486.0f)
                lineTo(346.0f, 486.0f)
                close()
            }
        }
        .build()
...
private var _zoomIn48px: ImageVector? = null
